...
select a.year, a.unit, a.division, count(distinct a.student_ssn), b.housing_arrangements, sum(uwsa.stfa_aid_a.fin_aid_amount)
...
(select year, unit,division, student_ssn
			...
			entr_status = 'N' 
					...
					UWSA.STFA_AID_A,uwsa.stfa_recip_a b
				...
				b.year = '201314' and
				UWSA.STFA_AID_A.student_ssn = b.student_ssn and 
					  UWSA.STFA_AID_A.unit  = b.unit  and 
				  UWSA.STFA_AID_A.Division = b.division

group by a.year, a.unit, a.division, b.housing_arrangements
