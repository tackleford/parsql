...
select  d.year,d.unit,d.division, count(distinct d.student_ssn),min(d.housing_arrangements),  sum(fin.fin_aid_amount),
case 
        ...
        from
                (select year, unit,division, student_ssn
                    ...
                    /*  (UWSA.STFA_AID_A.FIN_AID_TYPE  in ('24','28','31','41','43'))    */    
						...
						/*	 UWSA.STFA_AID_A.fin_aid_type in ('10','11','12','16','17','18','19','21','22','24','25','28','29','31','34','33','35','36','37','38','39','41','42','43','44','45','47','48','74','85')   */
                       and 
